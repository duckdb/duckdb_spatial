...
/* -------------------------------------------------------------------- */
    ...
    psSHP->fpSHP = psSHP->sHooks.FOpen(psSHP->sHooks.userData, pszFullname, pszAccess);
    ...
    psSHP->fpSHX = psSHP->sHooks.FOpen(psSHP->sHooks.userData, pszFullname, pszAccess);
    if (psSHP->fpSHX == SHPLIB_NULLPTR)
    {
        memcpy(pszFullname + nLenWithoutExtension, ".SHX", 5);
        psSHP->fpSHX = psSHP->sHooks.FOpen(psSHP->sHooks.userData, pszFullname, pszAccess);
...
/* -------------------------------------------------------------------- */
    ...
    memcpy(pszFullname, pszLayer, nLenWithoutExtension);
    memcpy(pszFullname + nLenWithoutExtension, ".shp", 5);
    SAFile fpSHP = psHooks->FOpen(psHooks->userData, pszFullname, pszAccess);
    if (fpSHP == SHPLIB_NULLPTR)
    {
        memcpy(pszFullname + nLenWithoutExtension, ".SHP", 5);
        fpSHP = psHooks->FOpen(psHooks->userData, pszFullname, pszAccess);
    }
    ...
    SAFile fpSHX = psHooks->FOpen(psHooks->userData, pszFullname, pszSHXAccess);
...
/* -------------------------------------------------------------------- */
    ...
    memcpy(pszFullname, pszLayer, nLenWithoutExtension);
    memcpy(pszFullname + nLenWithoutExtension, ".shp", 5);
    SAFile fpSHP = psHooks->FOpen(psHooks->userData, pszFullname, "w+b");
    if (fpSHP == SHPLIB_NULLPTR)
    {
        char szErrorMsg[200];
    ...
    memcpy(pszFullname + nLenWithoutExtension, ".shx", 5);
    SAFile fpSHX = psHooks->FOpen(psHooks->userData, pszFullname, "w+b");
    if (fpSHX == SHPLIB_NULLPTR)
    {
        char szErrorMsg[200];
        snprintf(szErrorMsg, sizeof(szErrorMsg), "Failed to create file %s: %s",
