...
protected:
    ...
    Point(ArenaAllocator &alloc, uint32_t size, bool has_z, bool has_m) : SinglePartGeometry(TYPE, alloc, size, has_z, has_m) {
    }

public:
	static constexpr GeometryType TYPE = GeometryType::POINT;

    static Point Empty(bool has_z = false, bool has_m = false) { return Point(has_z, has_m); }
    static Point Create(ArenaAllocator &alloc, uint32_t size, bool has_z, bool has_m) { return Point(alloc, size, has_z, has_m); }
...
public:
    ...
    static LineString Empty(bool has_z = false, bool has_m = false) { return LineString(has_z, has_m); }
    static LineString Create(ArenaAllocator &alloc, uint32_t count, bool has_z, bool has_m) { return LineString(alloc, count, has_z, has_m); }
...
public:
    ...
    static Polygon Empty(bool has_z = false, bool has_m = false) { return Polygon(has_z, has_m); }
    static Polygon Create(ArenaAllocator &alloc, uint32_t count, bool has_z, bool has_m) { return Polygon(alloc, count, has_z, has_m); }
...
public:
    ...
    static MultiPoint Empty(bool has_z = false, bool has_m = false) { return MultiPoint(has_z, has_m); }
    static MultiPoint Create(ArenaAllocator &alloc, uint32_t count, bool has_z, bool has_m) { return MultiPoint(alloc, count, has_z, has_m); }
};
...
public:
    ...
    static MultiLineString Empty(bool has_z = false, bool has_m = false) { return MultiLineString(has_z, has_m); }
    static MultiLineString Create(ArenaAllocator &alloc, uint32_t count, bool has_z, bool has_m) { return MultiLineString(alloc, count, has_z, has_m); }
};
...
public:
    ...
    static MultiPolygon Empty(bool has_z = false, bool has_m = false) { return MultiPolygon(has_z, has_m); }
    static MultiPolygon Create(ArenaAllocator &alloc, uint32_t count, bool has_z, bool has_m) { return MultiPolygon(alloc, count, has_z, has_m); }
};
...
public:
    ...
    static GeometryCollection Empty(bool has_z = false, bool has_m = false) { return GeometryCollection(has_z, has_m); }
    static GeometryCollection Create(ArenaAllocator &alloc, uint32_t count, bool has_z, bool has_m) { return GeometryCollection(alloc, count, has_z, has_m); }
};
