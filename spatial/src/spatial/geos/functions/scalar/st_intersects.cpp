...
void GEOSScalarFunctions::RegisterStIntersects(ClientContext &context) {
	...
	set.AddFunction(ScalarFunction({GeoTypes::GEOMETRY(), GeoTypes::GEOMETRY()}, LogicalType::BOOLEAN, IntersectsFunction, nullptr, nullptr, nullptr, GEOSFunctionLocalState::Init));
