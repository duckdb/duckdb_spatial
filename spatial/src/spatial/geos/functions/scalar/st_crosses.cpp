...
void GEOSScalarFunctions::RegisterStCrosses(ClientContext &context) {
	...
	set.AddFunction(ScalarFunction({GeoTypes::GEOMETRY(), GeoTypes::GEOMETRY()}, LogicalType::BOOLEAN, CrossesFunction, nullptr, nullptr, nullptr, GEOSFunctionLocalState::Init));
