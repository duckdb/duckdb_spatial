...
void GEOSScalarFunctions::RegisterStWithin(ClientContext &context) {
	...
	set.AddFunction(ScalarFunction({GeoTypes::GEOMETRY(), GeoTypes::GEOMETRY()}, LogicalType::BOOLEAN, WithinFunction, nullptr, nullptr, nullptr, GEOSFunctionLocalState::Init));
