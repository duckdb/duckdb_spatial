...
void GEOSScalarFunctions::RegisterStTouches(ClientContext &context) {
	...
	set.AddFunction(ScalarFunction({GeoTypes::GEOMETRY(), GeoTypes::GEOMETRY()}, LogicalType::BOOLEAN, TouchesFunction, nullptr, nullptr, nullptr, GEOSFunctionLocalState::Init));
