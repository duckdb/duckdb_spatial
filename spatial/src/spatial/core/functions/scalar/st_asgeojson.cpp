...
// GEOMETRY -> GEOJSON
//------------------------------------------------------------------------------
void GeometryToGeoJSONFunction(DataChunk &args, ExpressionState &state, Vector &result) {
...
void CoreScalarFunctions::RegisterStAsGeoJSON(ClientContext &context) {
	...
	CreateScalarFunctionInfo info(ScalarFunction("ST_AsGeoJSON", {GeoTypes::GEOMETRY()}, LogicalType::VARCHAR, GeometryToGeoJSONFunction, nullptr, nullptr, nullptr, GeometryFunctionLocalState::Init));
