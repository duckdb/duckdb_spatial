...
static unique_ptr<GlobalTableFunctionState> Init(ClientContext &context, TableFunctionInitInput &input) {
    ...
    result->xy_geoms.insert(result->xy_geoms.end(), std::make_move_iterator(points.begin()), std::make_move_iterator(points.end()));
    result->xy_geoms.insert(result->xy_geoms.end(), std::make_move_iterator(lines.begin()), std::make_move_iterator(lines.end()));
    result->xy_geoms.insert(result->xy_geoms.end(), std::make_move_iterator(polygons.begin()), std::make_move_iterator(polygons.end()));
    result->xy_geoms.insert(result->xy_geoms.end(), std::make_move_iterator(multi_points.begin()), std::make_move_iterator(multi_points.end()));
    result->xy_geoms.insert(result->xy_geoms.end(), std::make_move_iterator(multi_lines.begin()), std::make_move_iterator(multi_lines.end()));
    result->xy_geoms.insert(result->xy_geoms.end(), std::make_move_iterator(multi_polygons.begin()), std::make_move_iterator(multi_polygons.end()));
    result->xy_geoms.insert(result->xy_geoms.end(), std::make_move_iterator(geometry_collections.begin()), std::make_move_iterator(geometry_collections.end()));
