...
void GEOSScalarFunctions::RegisterStUnion(ClientContext &context) {
	auto &catalog = Catalog::GetSystemCatalog(context);

	ScalarFunctionSet set("ST_Union");

	set.AddFunction(ScalarFunction({GeoTypes::GEOMETRY(), GeoTypes::GEOMETRY()}, GeoTypes::GEOMETRY(), UnionFunction, nullptr, nullptr, nullptr, GEOSFunctionLocalState::Init));
